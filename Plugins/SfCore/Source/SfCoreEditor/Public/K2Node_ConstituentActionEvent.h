 ...
 */
UCLASS()
class SFCOREEDITOR_API UK2Node_ConstituentActionEvent : public UK2Node, public IK2Node_EventNodeInterface
{
	GENERATED_BODY()
	
	UK2Node_ConstituentActionEvent();
	...
	inline static const FName ServerExecuteFunctionName = "Server_OnExecute";
	inline static const FName PredictedExecuteFunctionName = "Predicted_OnExecute";
	inline static const FName AutonomousExecuteFunctionName = "Autonomous_OnExecute";
	inline static const FName SimulatedExecuteFunctionName = "Simulated_OnExecute";
